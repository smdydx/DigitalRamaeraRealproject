...
// Placeholder for the actual ServiceEnquiryForm component
const ServiceEnquiryForm = ({ serviceName }) => {
  return (
    <div>
      <h2>{serviceName} Enquiry Form</h2>
      {/* Add actual form fields here */}
      <p>Placeholder for enquiry form fields.</p>
    ...
    <div className="min-h-screen bg-background relative pt-20">
      ...
      <div className="container mx-auto px-4">
        <motion.div variants={staggerContainer} initial="hidden" animate="visible" className="space-y-16">
          ...
          <motion.div variants={fadeIn("up", "tween", 0.6, 1)} className="max-w-3xl mx-auto mt-16">
            <ServiceEnquiryForm serviceName="Company Incorporation" />
          </motion.div>
        </motion.div>
      </div>
    </div>
